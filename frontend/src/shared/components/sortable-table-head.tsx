  ...
  return (
    ...
    >
      <button
        ...
        aria-label={t(nextOrder === "asc" ? "common.sortAscending" : "common.sortDescending", {
          column: typeof children === "string" ? children : "",
        })}
      ...
      >
        ...
        <Icon
          className={cn(
            ...
            active
              ? "text-foreground"
              : "text-muted-foreground/45 group-hover/sort:text-muted-foreground",
          )}
          aria-hidden
        />
      </button>
