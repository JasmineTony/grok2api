...
export type DashboardDTO = {
  ...
  topAccounts: Array<{
    ...
    accountName: string;
    provider: string;
    usage: DashboardDimensionUsageDTO;
  }>;
  topClientKeys: Array<{
    clientKeyId: string;
...
const dashboardSeriesItem = hasShape({
  ...
  tokens: isNumber,
  actualCostUsdTicks: isNumber,
  estimatedCostUsdTicks: isNumber,
  billedCostUsdTicks: isNumber,
...
const decodeDashboard = createObjectDecoder<DashboardDTO>("dashboard", {
  ...
  resources: hasShape({
    activeAccounts: isNumber,
    totalAccounts: isNumber,
    buildAccounts: isNumber,
    webAccounts: isNumber,
    consoleAccounts: isNumber,
    enabledModels: isNumber,
    totalModels: isNumber,
    activeClientKeys: isNumber,
    totalClientKeys: isNumber,
  }),
  ...
  topAccounts: isArrayOf(
    hasShape({
      accountId: isString,
      accountName: isString,
      provider: isString,
      usage: dashboardDimensionUsage,
    }),
  ),
  topClientKeys: isArrayOf(
    hasShape({ clientKeyId: isString, clientKeyName: isString, usage: dashboardDimensionUsage }),
  ),
});
...
export function getDashboard(
  ...
  return client.request(`/api/admin/v1/dashboard?${query.toString()}`, {}, decodeDashboard);
}
