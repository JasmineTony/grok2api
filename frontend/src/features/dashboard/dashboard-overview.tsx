    ...
    <section aria-label={t("dashboard.usage")}>
      <div className="grid gap-2 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <DashboardMetric
          ...
          detail={t("dashboard.costComposition", {
            actual: formatUSD(usage?.actualCostUsdTicks ?? 0, locale),
        ...
        <div className="grid min-h-[260px] w-full flex-1 grid-cols-[minmax(0,1fr)_minmax(128px,0.8fr)] items-center gap-4">
          <div className="relative mx-auto size-44 max-w-full">
            <div
              ...
              style={{
                background: `conic-gradient(oklch(0.696 0.17 162.48) ${Math.min(100, Math.max(0, availability))}%, var(--muted) 0)`,
              }}
            >
          ...
          <div className="min-w-0 divide-y divide-border/60">
            ...
            <ResourceSummary
              ...
              detail={t("dashboard.modelsAvailableSummary", {
                enabled: formatNumber(resources?.enabledModels ?? 0, locale),
            ...
            <ResourceSummary
              ...
              detail={t("dashboard.keysAvailableSummary", {
                active: formatNumber(resources?.activeClientKeys ?? 0, locale),
