                    ...
                    <div className="overflow-hidden rounded-md bg-background/85 p-1">
                      ...
                      <div className="mt-1 max-h-40 overflow-y-auto overscroll-contain sm:max-h-44">
                        ...
                        {visibleAccountOptions.map((account) => {
                          ...
                          return (
                            <label key={account.id} htmlFor={controlId} className={cn("flex h-8 cursor-pointer items-center gap-2.5 rounded-md px-2 text-xs transition-colors hover:bg-accent/55", checked && "bg-accent")}>
