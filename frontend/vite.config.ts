    ...
    rolldownOptions: {
      output: {
        codeSplitting: {
          groups: [
            {
              name: "vendor-chart-runtime",
              test: new RegExp(
                "node_modules/(d3-|internmap|decimal\\.js-light|react-fast-compare)",
              ),
              priority: 90,
              minModuleSize: 0,
            ...
            {
              name: "vendor-router",
              test: new RegExp("node_modules/react-router"),
              priority: 80,
              minModuleSize: 0,
              includeDependenciesRecursively: false,
            },
            ...
            {
              name: "vendor-query",
              test: new RegExp("node_modules/@tanstack/"),
              priority: 60,
              minModuleSize: 0,
              includeDependenciesRecursively: false,
            },
            ...
            {
              name: "vendor-radix",
              test: new RegExp("node_modules/@radix-ui/"),
              priority: 40,
              minModuleSize: 0,
            ...
            {
              name: "vendor-app-ui",
              test: new RegExp("node_modules/(next-themes|sonner)/"),
              priority: 30,
              minModuleSize: 0,
              includeDependenciesRecursively: false,
            },
